export const site = {
  name: "The GTM School",
  location: "Bangalore",
  fullName: "The GTM School, Bangalore",
  presents: "AI Learn Circle × WIPM presents",
  tagline: "A hands-on GTM series for builders",
  label: "Bangalore · Sept to Oct 2026",
  primaryCta: {
    label: "Register for free",
    href: "https://luma.com/gtmschool",
  },
  registerCta: {
    label: "Register now",
    href: "https://luma.com/gtmschool",
  ...
  eventUrlPlaceholder: "https://luma.com/gtmschool",
  social: {
    x: "https://x.com/",
